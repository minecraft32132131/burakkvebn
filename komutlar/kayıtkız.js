...
if(!message.member.roles.has(`726503973078696007`)) return;
...
let role = message.guild.roles.get(`726510107713732638`)// kız rol id
let unregistered = message.guild.roles.get(`726516583006077019`)// kayıtsız rol id
let channel = message.guild.channels.get(`758432913866883095`) || message.channel// Log kanal id girin, boş bırakırsanız komutun kullanıldığı kanala logu yollar.
